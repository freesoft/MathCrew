...
the licensor's copyright in it for any permitted purpose, other than
...
Use by any charitable organization, public research organization,
public safety or health organization, environmental protection
...
**Educational institutions and schools** are excluded from this section.
Use by educational institutions, schools, tutoring services, or any
education-related organization requires prior written approval from the
licensor. To request approval, reach out to the licensor via LinkedIn
(linked on the [GitHub profile](https://github.com/freesoft)).
